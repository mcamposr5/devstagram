    ...
    <div class="md:flex md:justify-between">
        ...
        <div class="md:w-1/2 px-10">
            <form id="dropzone" class="dropzone border-dashed border-2 w-full h-96 rounded flex flex-col justify-center items-center"
                method="POST" enctype="multipart/form-data" action=" {{ route('imagenes.store') }} ">
                @csrf
            </form>
        </div>
            ...
            <form action="{{ route('posts.store') }}" method="POST" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <textarea
                        id="descripcion"
                        name="descripcion"
                        placeholder="Agrega una descripcion a tu publicación"
                        class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror"
                    >{{ old('descripcon') }}</textarea>
                ...
                <input type="submit" value="Cargar publicación"
